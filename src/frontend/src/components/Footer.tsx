...
export function Footer({ onScrollTo }: FooterProps) {
  ...
  const appId = encodeURIComponent(
    typeof window !== "undefined" ? window.location.hostname : "kare2u",
  );
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p
              ...
              style={{ color: "oklch(0.84 0.065 220)" }}
            >
            ...
            >
              Gentle, eczema-focused skincare for babies and adults.
              Fragrance-free, dermatologist-inspired, and made with love.
            </p>
          ...
          <div>
            <h3
              className="font-body font-bold text-sm uppercase tracking-widest mb-5"
              style={{ color: "oklch(0.84 0.065 220)" }}
            >
              Navigation
            </h3>
          ...
          <div>
            <h3
              className="font-body font-bold text-sm uppercase tracking-widest mb-5"
              style={{ color: "oklch(0.88 0.055 150)" }}
            >
              Our Products
            </h3>
            <ul className="space-y-3">
        ...
        <div
          ...
          style={{ borderColor: "oklch(0.32 0.04 230)" }}
        />
        ...
        >
          ...
          <p className="flex items-center gap-1.5">
            Built with <span style={{ color: "oklch(0.72 0.09 220)" }}>♥</span>{" "}
            using{" "}
            <a
