...
export function Hero({ onShopBaby, onShopAdult }: HeroProps) {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, oklch(0.96 0.04 220) 0%, oklch(0.98 0.02 150) 50%, oklch(0.97 0.03 200) 100%)",
      }}
    >
      ...
      <div
        className="absolute bottom-4 right-32 z-10 hidden lg:block"
        aria-hidden="true"
      >
        <LeafMotif color="blue" size="lg" opacity={0.25} rotate={-30} />
      </div>
      <div
        className="absolute top-16 left-8 z-10 hidden lg:block"
        aria-hidden="true"
      >
        <LeafMotif color="green" size="md" opacity={0.2} rotate={45} />
      </div>
      <div
        className="absolute bottom-8 left-24 z-10 hidden md:block"
        aria-hidden="true"
      >
        <LeafMotif color="blue" size="sm" opacity={0.3} rotate={-15} />
      </div>
      <div
        className="absolute top-4 right-1/3 z-10 hidden xl:block"
        aria-hidden="true"
      >
      ...
      <div className="relative z-20 container mx-auto px-6 py-20 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 text-center lg:text-left max-w-2xl">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-brand-navy leading-tight mb-4">
            Because your skin{" "}
            <span className="text-brand-blue-dark italic">
              deserves better.
            </span>
          </h1>
          ...
          <p className="font-body text-lg md:text-xl text-foreground/70 mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
            Gentle, fragrance-free formulas crafted for sensitive and
            eczema-prone skin — safe for babies, effective for adults.
          </p>
        ...
        <div className="shrink-0 relative hidden lg:block">
          ...
          >
            ...
            <div className="relative z-10 text-center p-8">
              ...
              <p className="font-display text-brand-navy font-semibold text-lg">
