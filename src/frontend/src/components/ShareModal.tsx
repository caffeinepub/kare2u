    ...
    >
      ...
      >
        ...
        <DialogDescription className="sr-only">
          Your Kare2U site is published and live. Scan the QR code or copy the
          link to share it.
        </DialogDescription>
        ...
        <div className="px-6 py-6 flex flex-col items-center gap-5">
          ...
          >
            <Globe
              size={14}
              style={{ color: "oklch(0.55 0.08 150)", flexShrink: 0 }}
            />
            <span
          ...
          <div
            ...
            style={{
              background: "white",
              border: "2px solid oklch(0.88 0.055 150)",
            }}
          >
            <img
              src={qrUrl}
          ...
          >
            Anyone who scans this code or visits the link will see your live
            Kare2U site.
          </p>
