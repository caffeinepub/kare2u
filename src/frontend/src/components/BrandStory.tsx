        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            >
              ...
              <span
                ...
                style={{ color: "oklch(0.35 0.09 150)" }}
              >
                Natural
              </span>
            </div>
            ...
            >
              ...
              <span
                className="font-body text-xs font-bold mt-1"
                style={{ color: "oklch(0.35 0.09 220)" }}
              >
                Trusted
              </span>
            </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <div
              ...
              style={{ color: "oklch(0.42 0.03 230)" }}
            >
              <p>
                Kare2U was born out of a deeply personal journey. When our
                founder's child was diagnosed with eczema, the search for safe,
                effective skincare became an exhausting daily struggle. Most
                products either irritated the skin further or were filled with
                ingredients that felt more like a chemistry experiment than a
                gentle remedy.
              </p>
              <p>
                That frustration became our purpose. We spent years researching,
                testing, and collaborating with dermatologists to create
                formulas that truly work for sensitive and eczema-prone skin —
                without the harsh chemicals, synthetic fragrances, or hidden
                irritants that make flare-ups worse.
              </p>
              <p>
                Today, Kare2U is more than a skincare brand. It's a community of
                families who understand the daily reality of sensitive skin. We
                believe in radical transparency — every ingredient is listed,
                every formula is tested, and every product is made with the same
                love and care we'd want for our own family.
              </p>
            </div>
