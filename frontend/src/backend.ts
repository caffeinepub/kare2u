...
import type { Category as _Category, Product as _Product, ProductType as _ProductType, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
...
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "conditioner" in value ? ProductType.conditioner : "lotion" in value ? ProductType.lotion : "shampoo" in value ? ProductType.shampoo : "serum" in value ? ProductType.serum : "bodyWash" in value ? ProductType.bodyWash : value;
}
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "adult" in value ? Category.adult : "baby" in value ? Category.baby : value;
}
